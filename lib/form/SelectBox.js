...
var _ActionSheet = require('common/dialog/ActionSheet');

var _svg = require('common/svg');

var _Mask = require('common/mask/Mask');
...
var SelectBox = function (_Component) {
  ...
  SelectBox.prototype._openSheet = function _openSheet() {
    this.setState({ action: true });
  };

  SelectBox.prototype._cancelSheet = function _cancelSheet() {
    this.setState({ action: false });
  };

  SelectBox.prototype._actionHandel = function _actionHandel(str) {
  ...
  SelectBox.prototype._renderAction = function _renderAction(item, index) {
