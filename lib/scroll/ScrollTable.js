...
var ScrollTable = function (_Component) {
	...
	function ScrollTable(props) {
		...
		// this.cW = 0; 				//内容区宽度
		// this.cH = 0; 				//内容区高度
		var _this = _possibleConstructorReturn(this, (ScrollTable.__proto__ || Object.getPrototypeOf(ScrollTable)).call(this, props));
	...
	_createClass(ScrollTable, [{
		...
		key: '_setTransition',
		value: function _setTransition(val) {
		...
		key: '_renderHeadTh',
		value: function _renderHeadTh(col, i) {
		...
		key: '_sort',
		value: function _sort(key, index) {
		...
		key: '_renderFixedTitle',
		value: function _renderFixedTitle(row, i) {
			var _this2 = this;
		...
		key: '_renderFixedTitleCol',
		value: function _renderFixedTitleCol(col, i, row) {
		...
		key: '_renderCon',
		value: function _renderCon(row, i) {
			var _this3 = this;
		...
		key: '_renderConCol',
		value: function _renderConCol(col, i, j) {
